...
function SkinConfig:init(config)
    for _, vConfig in pairs(config) do
        ...
        table.insert(SkinConfig.settings, data)
    end
    ...
    --print("SkinConfig:init " .. inspect.inspect(self.settings))
end

function SkinConfig:getSkinConfig(id)
...
--function SkinConfig:getFirstSkin()
--    return self.settings[1].id
--end

function SkinConfig:getDefaultSkin(player)
