...
BackHallManager.nextGameType = "g1050"
...
function BackHallManager:addPlayer(player)
    ...
    GameAnalytics:design(player.userId, 0, {"g1050backhome", tostring(player.userId), tostring(self.nextGameType)})
