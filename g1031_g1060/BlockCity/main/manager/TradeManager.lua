...
function TradeManager:judgeConsumeEntrance(rakssid, extra, moneyType)
...
function TradeManager:checkCash(userId, totalMoney)
    local player = PlayerManager:getPlayerByUserId(userId)
    if not player or player:getCurrency() < totalMoney then
        return false
    end
